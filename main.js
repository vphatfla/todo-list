...
function loadProject(){
    let projectList = (0,_storage__WEBPACK_IMPORTED_MODULE_2__.getProjectList)();
...
function displayTask(id){
    ...
    for (let  i = 0; i<taskArray.length; i++){
        ...
        const dueDayFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(taskArray[i].dueDay), 'MM/dd/yyyy');
